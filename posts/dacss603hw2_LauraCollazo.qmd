...
```
We can reject the null hypothesis because the p-value is below 0.05. Furthermore, the X-squared value, as seen below, is higher than the critical value so the null hypothesis can be rejected. 
