...
1.Is there a significant correlation between mental health status and CGPA among university students?
       2.Does the use of mental health resources, such as counselling or therapy, have a positive impact on academic performance?
       3.Are there demographic differences in the relationship between mental health and academic performance, such as differences based on gender or ethnicity?

Hypothesis 	

Null Hypothesis (H0): There is a no significant negative correlation between poor mental health status and CGPA among university students.

There is a significant negative correlation between poor mental health status and CGPA among university students.
...
This dataset has 101 rows and 11 columns 
