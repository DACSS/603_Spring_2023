...
#1. Post characteristics: #1.1.Popularity
...
post might significantly influence its engagement. \#### Exit rate as
engagement Lets review how it is impacting exit rate :
...
#Adding IVs to the model Now as we reviewed Independent variables,I will
create a model : ##2.1 Engagement of all viewers
...
##2.2 Engagement of loyal viewers viewers Now we will use loyal's
readers engagement as DV:
...
Measuring how early comments impact emgagement:
