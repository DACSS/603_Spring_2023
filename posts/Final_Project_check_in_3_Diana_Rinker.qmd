...
We can see  significance of popularity and  high R^2 of the model, and can conclude that popularity overall decreases engagement.  To explore this connection further, I will review Sources of users that are coming to the website.
...
We can see no significant connection between early comments and google
referrals.
Next,  I will explore whether days of the week and time of the post
...
Now I will plot  distribution of exit rates per referrals: 
```{r, echo=T}
...
This table demonstrates difference in models depending on the data set used for its production.  Specifically, the difference between 2021 and 2022 demonstrates : 
        ...
        7. Interla bds referrals assocoated with lower engagement for both 2021 and 2022. 
        8. LL referrals assocoated with lower engagement for both 2021 and 2022. 
...
Summary: the model, that takes into account referral sources demonstrated a better fit, and addressed issue with residuals identified in diagnostics, especially for 2022.
