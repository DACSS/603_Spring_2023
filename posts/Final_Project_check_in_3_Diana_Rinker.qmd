...
I will use "Exit rate" s my main engagement  variable, as it reporesents the first engagement chouce that all site users make: to stay on the site or leave. Using log() of popularity is showing a better fitted model: 
...
## 3.2 Adding other/confounding variables.
...
```
Number of comments shows to be significant, negatively impacting overall engagement. Considering our earlier finding, that early comments increase popularity and therefore decrease overall engagement, this is expected. 
Tuesday as a level of "weekday" variable also shows to significantly decrease engagement. 
