...
I think the model without the interaction represents the relationship of size and newness to the outcome price because it's simpler, easier to interpret, and 
there is more statistical significance as opposed to the model with the interaction. Despite that, the RSS, R-square, and adjusted R-square are similar.
